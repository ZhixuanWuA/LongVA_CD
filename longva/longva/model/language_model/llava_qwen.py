...
class LlavaQwenForCausalLM(Qwen2ForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        image_tem: Optional[torch.FloatTensor] = None,
        images_mask: Optional[torch.FloatTensor] = None,
        ...
        model_inputs.update(
            {
                ...
                "attention_mask": attention_mask,
                "images": kwargs.get("images_mask", None),
            }
        )
        return model_inputs
    
    def prepare_inputs_for_generation_temcd(
        self, input_ids, past_key_values=None, attention_mask=None, inputs_embeds=None, **kwargs
    ):
        if past_key_values:
            input_ids = input_ids[:, -1:]
        ...
        model_inputs.update(
            {
                ...
                "images": kwargs.get("image_tem", None),
            }
        )
        return model_inputs
