...
from videoprocess.VCD_sample_ori import evolve_vcd_sampling
evolve_vcd_sampling()
...
def run_inference(args):
    ...
    for sample in tqdm(gt_questions):
        ...
        for fmt in tqdm(video_formats):  # Added this line
            ...
            video_temcd_dir = os.path.join(args.video_temcd_dir, f"{video_name}{fmt}")
            video_spacd_dir = os.path.join(args.video_spacd_dir, f"{video_name}{fmt}")
            print(f'video_temcd_dir:{video_temcd_dir}, video_spacd_dir:{video_spacd_dir}')
